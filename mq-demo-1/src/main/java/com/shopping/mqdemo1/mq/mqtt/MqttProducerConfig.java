package com.shopping.mqdemo1.mq.mqtt;
...
public class MqttProducerConfig {
    ...
    public MqttClient mqttClient() throws MqttException {
        ...
        MqttClient client = new MqttClient(broker, "samples-client", persistence);
    ...
    public MqttAsyncClient mqttAsyncClient() throws MqttException {
        MemoryPersistence persistence = new MemoryPersistence();
        MqttAsyncClient asyncClient = new MqttAsyncClient(broker, "samples-async-client",
                persistence);
